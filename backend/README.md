...
## Project Structure
    ...
    ├── testtemplate_app_de_27439  # Django project configurations
...
1. Clone this repo and `cd testtemplate_app_de_27439`
...
2. Clone this repo and `cd testtemplate_app_de_27439`
